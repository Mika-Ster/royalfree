...
<footer class="bg-light border-top mt-auto">
  <div class="container py-4 small text-muted d-flex flex-wrap gap-3 justify-content-between">
    ...
    <div class="d-flex gap-3 align-items-center">
      <a class="link-secondary text-decoration-none" href="impressum.php">Impressum</a>
      <a class="link-secondary text-decoration-none" href="legal.php">Rechtliche Informationen</a>
